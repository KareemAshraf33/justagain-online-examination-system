...
<button type="button" class="btn btn-primary" data-toggle='modal' data-target='#addQnaModal'>Add Q&A</button>
      ...
      @if(count($questions) > 0)
        @foreach ($questions as $question )
         <tr>
            ...
            <td> <a href="" class="ansButton" data-id="{{ $question->id }}" data-toggle='modal' data-target='#showAnsModal' >See Answers </td>
         </tr>   
        @endforeach
      @else
        <tr>
...
<!-- Show answer Modal -->
<div class="modal fade" id="showAnsModal" tabindex="-1" role="dialog" aria-labelledby="">
  <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
     <div class="modal-header">
...
<script>
  $(document).ready(function(){
      ...
      $("#addAnswer").click(function(){
          if($(".answers").length >=5){
              $(".error").text("You can add Maximum 5 answers.")
              setTimeout(function(){
                 $(".error").text("");
              },2000);
           }
